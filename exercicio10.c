...
int main(){
    ...
    // precisamos fazer uma árvore AVL com os valores { 1,2,3,4,5,6,7 }, para isso, basta adicionar os elementos
    //      respeitando a condição da árvore AVL

    No *raizAVL = criar_no(4,criar_no(2,criar_no(1,NULL,NULL), criar_no(3,NULL,NULL)), 
    criar_no(6,criar_no(5,NULL,NULL),criar_no(7,NULL,NULL)));

    int fator_de_balanceamentoAVL = calcular_fator_balanceamento(raizAVL);

    printf("\nFator de balanceamento da arvore AVL eh: %d\n", fator_de_balanceamentoAVL);
