...
int main(){
    ...
    /*
        Tendo em vista que a árvore binária de busca tem todos os elementos à esquerda
            menores do que os da direita, podemos apenas imprimir o percurso in-ordem,
            para que os elementos saiam ordenados.
    */
   No *raiz2 = criar_no(5,criar_no(4, NULL, NULL), criar_no(6, NULL, 
                                                criar_no(10,criar_no(9, NULL, NULL), criar_no(15, NULL, NULL))));

    percurso_em_ordem(raiz2);
